...
public class RotationManager implements InstanceAccess {
    ...
    public float[] getSimpleRotationsToEntity(Entity entity) {
        // target upper chest/spine area for reliable melee hit registration
        return RotationUtils.getRotations(entity.posX, entity.posY + entity.getEyeHeight() * 0.75, entity.posZ);
    }
