...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void runGameLoop() throws IOException {
        ...
        this.mcProfiler.startSection("root");
        this.updateDisplay();
        // removed thread yield here to prevent cpu core busy spinning on windows thread scheduler
    ...
    public int getLimitFramerate() {
        // cap main menu framerate to 60 fps to reduce thermal load and gpu shader utilization while idle in menus
        return this.theWorld == null && this.currentScreen != null ? Math.min(60, this.gameSettings.limitFramerate) : this.gameSettings.limitFramerate;
    }
